...
> jQuery。
> **jQuery 好处！！！**
> jQuery 是免费、开源的，jQuery 的语法设计可以使开发更加便捷，例如操作文档对象、选择DOM 元素、
> 制作动画效果、事件处理、使用Ajax 以及其他功能
...
> 3、怎么为按钮添加点击响应函数的？    答案：1、使用jQuery 查询到标签对象  2、使用标签对象.click( function(){} );
...
![image-20210808185705768](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210808185705768.png)

## 5.jQuery选择器（***重点**）

### 5.1 基本选择器（**重点**）

![image-20210808185922720](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210808185922720.png)
...
![image-20210808190439815](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210808190439815.png)
...
![image-20210808190543248](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210808190543248.png)
...
![image-20210811085230453](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210811085230453.png)
...
![image-20210811085332976](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210811085332976.png)
...
![image-20210811085510072](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210811085510072.png)

> **:input 匹配所有input, textarea, select 和button 元素**
> **:text 匹配所有文本输入框:password 匹配所有的密码输入框**
> **:radio 匹配所有的单选框**
> **:checkbox 匹配所有的复选框**
> **:submit 匹配所有提交按钮**
> **:image 匹配所有img 标签**
...
![image-20210811085740160](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210811085740160.png)
...
![image-20210811085833005](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210811085833005.png)
...
![image-20210811164557747](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210811164557747.png)
...
![image-20210816134844372](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210816134844372.png)
...
![image-20210816135221572](https://gitee.com/luck365/studypicture/raw/master/img/javaweb/jQuery/image-20210816135221572.png)
...
<script type="text/javascript">
$(function () {
// 创建一个用于复用的删除的function 函数
var deleteFun = function(){
// alert("删除操作的function : " + this);
// 在事件响应的function 函数中，有一个this 对象。这个this 对象是当前正在响应事件的dom 对象。
...
**$(function(){}); 和 window.onload = function(){}的区别？**他们**分别是在什么时候触发？**
1、jQuery 的页面加载完成之后是浏览器的内核解析完页面的标签创建好DOM 对象之后就会马上执行。
2、原生js 的页面加载完成之后，除了要等浏览器内核解析完标签创建好DOM 对象，还要等标签显示时需要的内容加载
完成。
**他们触发的顺序？**
